...
export const FALLBACK_SKILLS: CatalogSkill[] = [
  ...
  ["Git", "software", "information-technology"],
  ["GitHub", "software", "information-technology"],
  ["GitLab", "software", "information-technology"],
  ["Bitbucket", "software", "information-technology"],
  ["Docker", "software", "information-technology"],
  ["Kubernetes", "software", "information-technology"],
  ["CI/CD", "technical", "information-technology"],
  ["Jenkins", "software", "information-technology"],
  ["GitHub Actions", "software", "information-technology"],
  ["Terraform", "software", "information-technology"],
  ["Ansible", "software", "information-technology"],
  ["Python", "software", "information-technology"],
  ["Java", "software", "information-technology"],
  ["C#", "software", "information-technology"],
  ["C++", "software", "information-technology"],
  ["Go", "software", "information-technology"],
  ["Rust", "software", "information-technology"],
  ["PHP", "software", "information-technology"],
  ["Ruby", "software", "information-technology"],
  ["Swift", "software", "information-technology"],
  ["Kotlin", "software", "information-technology"],
  ["Scala", "software", "information-technology"],
  ["Perl", "software", "information-technology"],
  ["R", "software", "information-technology"],
  ["MATLAB", "software", "information-technology"],
  ["Vue.js", "software", "information-technology"],
  ["Angular", "software", "information-technology"],
  ["Next.js", "software", "information-technology"],
  ["Svelte", "software", "information-technology"],
  ["Express.js", "software", "information-technology"],
  ["Django", "software", "information-technology"],
  ["Flask", "software", "information-technology"],
  ["Spring Boot", "software", "information-technology"],
  ["Laravel", "software", "information-technology"],
  ["ASP.NET", "software", "information-technology"],
  ["Ruby on Rails", "software", "information-technology"],
  ["AWS", "software", "information-technology"],
  ["Microsoft Azure", "software", "information-technology"],
  ["Google Cloud Platform", "software", "information-technology"],
  ["Linux", "software", "information-technology"],
  ["Bash scripting", "technical", "information-technology"],
  ["PowerShell", "software", "information-technology"],
  ["Nginx", "software", "information-technology"],
  ["Apache", "software", "information-technology"],
  ["Redis", "software", "information-technology"],
  ["MongoDB", "software", "information-technology"],
  ["Elasticsearch", "software", "information-technology"],
  ["Kafka", "software", "information-technology"],
  ["RabbitMQ", "software", "information-technology"],
  ["GraphQL", "software", "information-technology"],
  ["REST API design", "technical", "information-technology"],
  ["Microservices architecture", "technical", "information-technology"],
  ["Serverless computing", "technical", "information-technology"],
  ["Machine Learning", "technical", "information-technology"],
  ["TensorFlow", "software", "information-technology"],
  ["PyTorch", "software", "information-technology"],
  ["Natural Language Processing", "technical", "information-technology"],
  ["Computer Vision", "technical", "information-technology"],
  ["Blockchain development", "technical", "information-technology"],
  ["Web3", "technical", "information-technology"],
  ["Cybersecurity", "technical", "information-technology"],
  ["Penetration testing", "technical", "information-technology"],
  ["DevOps", "technical", "information-technology"],
  ["Site Reliability Engineering", "technical", "information-technology"],
  ["Load balancing", "technical", "information-technology"],
  ["Container orchestration", "technical", "information-technology"],
  ["Infrastructure as Code", "technical", "information-technology"],
  ["Prometheus", "software", "information-technology"],
  ["Grafana", "software", "information-technology"],
  ["Jira", "software", "information-technology"],
  ["Confluence", "software", "information-technology"],
  ["Scrum methodology", "technical", "information-technology"],
  ["Agile project management", "technical", "information-technology"],
  ["Technical documentation", "administration", "information-technology"],
  ["Code review", "technical", "information-technology"],
  ["Unit testing", "technical", "information-technology"],
  ["Integration testing", "technical", "information-technology"],
  ["Test automation", "technical", "information-technology"],
  ["Selenium", "software", "information-technology"],
  ["Jest", "software", "information-technology"],
  ["Cypress", "software", "information-technology"],
  // ── Web Development Skills ──
  ["HTML5", "software", "information-technology"],
  ["CSS3", "software", "information-technology"],
  ["JavaScript", "software", "information-technology"],
  ["Responsive web design", "technical", "information-technology"],
  ["WordPress", "software", "media-creative"],
  ["Shopify", "software", "sales-retail"],
  ["Webflow", "software", "media-creative"],
  ["Wix", "software", "media-creative"],
  ["Squarespace", "software", "media-creative"],
  ["Drupal", "software", "media-creative"],
  ["Joomla", "software", "media-creative"],
  ["Web hosting management", "technical", "information-technology"],
  ["Domain management", "technical", "information-technology"],
  ["SSL certificate management", "technical", "information-technology"],
  ["Search Engine Optimization", "technical", "media-creative"],
  ["Search Engine Marketing", "technical", "media-creative"],
  ["Google Analytics", "software", "media-creative"],
  ["Google Tag Manager", "software", "media-creative"],
  ["Google Search Console", "software", "media-creative"],
  ["Pay-per-click advertising", "technical", "media-creative"],
  ["Social media advertising", "technical", "media-creative"],
  ["Email marketing automation", "technical", "media-creative"],
  ["Mailchimp", "software", "media-creative"],
  ["HubSpot", "software", "media-creative"],
  ["Figma", "software", "media-creative"],
  ["Sketch", "software", "media-creative"],
  ["Adobe XD", "software", "media-creative"],
  ["Wireframing", "technical", "media-creative"],
  ["Prototyping", "technical", "media-creative"],
  ["User research", "technical", "media-creative"],
  ["Usability testing", "technical", "media-creative"],
  ["Interaction design", "technical", "media-creative"],
  ["Information architecture", "technical", "media-creative"],
  ["Web accessibility (WCAG)", "technical", "media-creative"],
  ["Content strategy", "technical", "media-creative"],
  ["Copywriting", "technical", "media-creative"],
  ["A/B testing", "technical", "media-creative"],
  ["Conversion rate optimization", "technical", "media-creative"],
  ["Web performance optimization", "technical", "information-technology"],
  ["Progressive Web Apps", "technical", "information-technology"],
  ["Single Page Applications", "technical", "information-technology"],
  ["E-commerce platform management", "technical", "sales-retail"],
  ["Payment gateway integration", "technical", "sales-retail"],
  ["Product information management", "technical", "sales-retail"],
  ["Web content management", "technical", "media-creative"],
  ["Headless CMS", "technical", "information-technology"],
  // ── ERP Skills ──
  ["SAP ERP", "software", "finance-administration"],
  ["SAP S/4HANA", "software", "finance-administration"],
  ["SAP FICO", "software", "finance-administration"],
  ["SAP MM", "software", "finance-administration"],
  ["SAP SD", "software", "finance-administration"],
  ["SAP HCM", "software", "human-resources"],
  ["SAP SuccessFactors", "software", "human-resources"],
  ["SAP Business One", "software", "finance-administration"],
  ["Oracle ERP Cloud", "software", "finance-administration"],
  ["Oracle Financials", "software", "finance-administration"],
  ["Oracle HCM Cloud", "software", "human-resources"],
  ["Oracle NetSuite", "software", "finance-administration"],
  ["Oracle SCM Cloud", "software", "logistics-transport"],
  ["Oracle Database", "software", "information-technology"],
  ["Microsoft Dynamics 365", "software", "finance-administration"],
  ["Microsoft Dynamics 365 Finance", "software", "finance-administration"],
  ["Microsoft Dynamics 365 Supply Chain", "software", "logistics-transport"],
  ["Microsoft Dynamics 365 HR", "software", "human-resources"],
  ["Microsoft Dynamics 365 Sales", "software", "sales-retail"],
  ["Microsoft Power BI", "software", "information-technology"],
  ["Microsoft Power Platform", "software", "information-technology"],
  ["Workday HCM", "software", "human-resources"],
  ["Workday Finance", "software", "finance-administration"],
  ["Workday Payroll", "software", "human-resources"],
  ["Infor ERP", "software", "manufacturing-operations"],
  ["Infor CloudSuite", "software", "manufacturing-operations"],
  ["Sage Intacct", "software", "finance-administration"],
  ["Sage 50", "software", "finance-administration"],
  ["Sage X3", "software", "finance-administration"],
  ["Odoo ERP", "software", "finance-administration"],
  ["ERPNext", "software", "finance-administration"],
  ["Zoho ERP", "software", "finance-administration"],
  ["Epicor ERP", "software", "manufacturing-operations"],
  ["SYSPRO ERP", "software", "manufacturing-operations"],
  ["IFS ERP", "software", "manufacturing-operations"],
  ["Unit4 ERP", "software", "nonprofit-development"],
  ["ERP implementation", "technical", "finance-administration"],
  ["ERP data migration", "technical", "finance-administration"],
  ["ERP customization", "technical", "finance-administration"],
  ["ERP reporting and analytics", "technical", "finance-administration"],
  ["Master data management", "technical", "finance-administration"],
  ["Business process reengineering", "technical", "finance-administration"],
  ["Financial consolidation", "technical", "finance-administration"],
  ["Revenue recognition", "technical", "finance-administration"],
  ["Inventory planning (ERP)", "technical", "logistics-transport"],
  ["Procurement automation", "technical", "logistics-transport"],
  ["Warehouse management (WMS)", "technical", "logistics-transport"],
  ["Production planning (MRP)", "technical", "manufacturing-operations"],
  ["Quality management (QM)", "technical", "manufacturing-operations"],
  ["Plant maintenance (PM)", "technical", "manufacturing-operations"],
  ["Project system (PS)", "technical", "finance-administration"],
  ["Payroll integration (ERP)", "technical", "human-resources"],
  ["Talent management (ERP)", "technical", "human-resources"],
  ["CRM integration", "technical", "sales-retail"],
  ["Business Intelligence (BI)", "technical", "information-technology"],
  ["ETL processes", "technical", "information-technology"],
  ["SAP ABAP", "software", "information-technology"],
  ["SAP Fiori", "software", "information-technology"],
  ["SAP Integration Suite", "software", "information-technology"],
  ["Oracle APEX", "software", "information-technology"],
  ["Microsoft SQL Server", "software", "information-technology"],
  ["PL/SQL", "software", "information-technology"],
  ["Data warehousing", "technical", "information-technology"],
  ["Regulatory reporting (ERP)", "technical", "finance-administration"],
  ["Audit trail management", "technical", "finance-administration"],
  ["Intercompany accounting", "technical", "finance-administration"],
  ["Fixed asset management (ERP)", "technical", "finance-administration"],
  ["Cost centre accounting", "technical", "finance-administration"],
  ["Profit centre accounting", "technical", "finance-administration"],
  ["Budgeting and forecasting (ERP)", "technical", "finance-administration"],
  ["Supply chain visibility", "technical", "logistics-transport"],
  ["Demand planning", "technical", "logistics-transport"],
  ["Vendor management (ERP)", "technical", "logistics-transport"],
  ["Contract lifecycle management", "technical", "legal-compliance"],
